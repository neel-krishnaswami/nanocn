...
val parse_expr : string -> file:string -> (SurfComp.se, string) result
...
val parse_prog : string -> file:string -> (SurfComp.se Prog.t, string) result
(** [parse_prog s ~file] parses a string as a complete program. *)

val parse_decl : string -> file:string -> (SurfComp.se Prog.decl, string) result
(** [parse_decl s ~file] parses a single declaration. *)

val parse_let : string -> file:string -> (Var.t * SurfComp.se, string) result
