...
val top : SourcePos.t -> ('e, SourcePos.t) t
val bot : SourcePos.t -> ('e, SourcePos.t) t
val conj : SourcePos.t -> ('e, SourcePos.t) t -> ('e, SourcePos.t) t -> ('e, SourcePos.t) t
val impl : SourcePos.t -> 'e -> ('e, SourcePos.t) t -> ('e, SourcePos.t) t
val forall_ : SourcePos.t -> Var.t -> Sort.sort -> ('e, SourcePos.t) t -> ('e, SourcePos.t) t
val atom : SourcePos.t -> 'e -> ('e, SourcePos.t) t
val is_ : SourcePos.t -> Label.t -> 'e -> ('e, SourcePos.t) t
...
val atom' :
  SourcePos.t -> ('e_ce, _) result -> ('e_ce, SourcePos.t) t
...
val impl' :
  ...
  ('e_ce, SourcePos.t) t -> ('e_ce, SourcePos.t) t
...
val forall_' :
  ...
  ('e, SourcePos.t) t -> ('e, SourcePos.t) t
